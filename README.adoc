...
At current early stage, external Mongodb dependency is still needed. Very soon self-contained Mongodb integration testing mechanism will
be enabled.

For now you need to substitute your Mongodb connection URL and database name to the following two lines in src/test/resources/hibernate
.properties:
