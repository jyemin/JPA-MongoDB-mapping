...
public class AttachmentKeys {
  ...
  private static final AttachmentKey<String> COLLECTION_NAME =
      new DefaultAttachmentKey<>("collectionName");
  private static final AttachmentKey<List<AstProjectStageSpecification>>
      PROJECT_STAGE_SPECIFICATIONS = new DefaultAttachmentKey<>("projectStageSpecifications");
  private static final AttachmentKey<String> FIELD_NAME = new DefaultAttachmentKey<>("fieldName");
  private static final AttachmentKey<AstValue> FIELD_VALUE =
      new DefaultAttachmentKey<>("fieldValue");
  private static final AttachmentKey<AstFilter> FILTER = new DefaultAttachmentKey<>("filter");
  private static final AttachmentKey<List<AstSortField>> SORT_FIELDS =
      new DefaultAttachmentKey<>("sortFields");
  private static final AttachmentKey<AstSortField> SORT_FIELD =
      new DefaultAttachmentKey<>("sortField");
  private static final AttachmentKey<List<AstStage>> JOIN_STAGES =
      new DefaultAttachmentKey<>("joinStages");
  private static final AttachmentKey<AstLookupStage> LOOKUP_STAGE =
      new DefaultAttachmentKey<>("lookupStage");
  ...
  private static final AttachmentKey<List<AstFieldUpdate>> FIELD_UPDATES =
      new DefaultAttachmentKey<>("fieldUpdates");
  private static final AttachmentKey<AstFieldUpdate> FIELD_UPDATE =
      new DefaultAttachmentKey<>("fieldUpdate");
