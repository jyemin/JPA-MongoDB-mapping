...
public class MongoSQLArrayJdbcType extends ArrayJdbcType {
  ...
  public <X> ValueBinder<X> getBinder(final JavaType<X> javaTypeDescriptor) {
    ...
    final ValueBinder<Object> elementBinder = getElementJdbcType()
        .getBinder(((BasicPluralJavaType<Object>) javaTypeDescriptor).getElementJavaType());
    return new BasicBinder<>(javaTypeDescriptor, this) {
      ...
      public Object getBindValue(X value, WrapperOptions options) throws SQLException {
        return ((MongoSQLArrayJdbcType) getJdbcType())
