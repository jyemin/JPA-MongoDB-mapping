...
import org.hibernate.sql.ast.tree.cte.*;
    ...
    protected boolean shouldInlineCte(TableGroup tableGroup) {
        if ( tableGroup instanceof CteTableGroup ) {
            ...
            if ( !supportsWithClauseInSubquery() && isInSubquery() ) {
                ...
                final CteContainer cteOwner = statementStack.findCurrentFirstWithParameter( cteName, MongodbSqlAstTranslator::matchCteContainerByStatement );
